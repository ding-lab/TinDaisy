#!/usr/bin/env python2
# Workflow run script auto-generated by command: '/usr/local/strelka2/bin/configureStrelkaSomaticWorkflow.py --exome --normalBam /data/StrelkaDemoCase.N.bam --tumorBam /data/StrelkaDemoCase.T.bam --referenceFasta /data/demo20.fa --config /data/strelka.WES.ini --runDir ./results/strelka/strelka_out'
#
...
sys.path.append(r'/usr/local/strelka2/lib/python')
...
main(r"/usr/local/tin-daisy/testing/results/strelka/strelka_out/runWorkflow.py.config.pickle","StrelkaSomatic",StrelkaSomaticWorkflow)
