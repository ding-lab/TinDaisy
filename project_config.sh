TUMOR_BAM="testing/StrelkaDemo.dat/StrelkaDemoCase.T.bam"
NORMAL_BAM="testing/StrelkaDemo.dat/StrelkaDemoCase.N.bam"
REFERENCE_FASTA="testing/StrelkaDemo.dat/demo20.fa" 
STRELKA_CONFIG="params/strelka.WES.ini"
VARSCAN_CONFIG="params/varscan.WES.ini"
PINDEL_CONFIG="params/pindel.WES.ini"
DBSNP_DB="testing/StrelkaDemo.dat/dbsnp-StrelkaDemo.noCOSMIC.vcf.gz"
CENTROMERE_BED="testing/StrelkaDemo.dat/ucsc-centromere.GRCh37.bed"
