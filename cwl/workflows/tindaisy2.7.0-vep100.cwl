class: Workflow
cwlVersion: v1.0
id: tindaisy2_7_0_vep100
doc: TinDaisy 2.7.0 workflow with VEP v100 annotation
label: TinDaisy2.7.0-vep100
inputs:
  - id: tumor_bam
    type: File
  - id: normal_bam
...
steps:
  ...
  - id: vep_annotate__tin_daisy
    ...
    out:
      - id: output_dat
    run: ../../submodules/VEP_annotate/cwl/vep_annotate.TinDaisy.v100.cwl
    label: vep_annotate v100 TinDaisy
  - id: stage_normal_bam
    in:
      - id: BAM
        source: normal_bam
